  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> a2CreaCuentaUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final a2CreaCuentaUsersRecord = a2CreaCuentaUsersRecordList.isNotEmpty
            ? a2CreaCuentaUsersRecordList.first
            : null;
