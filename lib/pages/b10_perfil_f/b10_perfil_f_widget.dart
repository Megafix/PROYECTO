...
class B10PerfilFWidget extends StatefulWidget {
  const B10PerfilFWidget({super.key});

  static String routeName = 'B10_PerfilF';
  static String routePath = 'b10PerfilF';

  @override
  State<B10PerfilFWidget> createState() => _B10PerfilFWidgetState();
}

class _B10PerfilFWidgetState extends State<B10PerfilFWidget> {
  late B10PerfilFModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => B10PerfilFModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> b10PerfilFUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final b10PerfilFUsersRecord = b10PerfilFUsersRecordList.isNotEmpty
            ? b10PerfilFUsersRecordList.first
            : null;
