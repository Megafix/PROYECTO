...
import 'c7_cambiar_contrasena_t_model.dart';
export 'c7_cambiar_contrasena_t_model.dart';

class C7CambiarContrasenaTWidget extends StatefulWidget {
  const C7CambiarContrasenaTWidget({super.key});

  static String routeName = 'C7_CambiarContrasenaT';
  static String routePath = 'c7CambiarContrasenaT';

  @override
  State<C7CambiarContrasenaTWidget> createState() =>
      _C7CambiarContrasenaTWidgetState();
}

class _C7CambiarContrasenaTWidgetState
    extends State<C7CambiarContrasenaTWidget> {
  late C7CambiarContrasenaTModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => C7CambiarContrasenaTModel());
                                                      ...
                                                      decoration:
                                                        ...
                                                        hintText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          '8s3nswdg' /* Ingresa la nueva contraseña */,
                                                        ),
                                                        hintStyle:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                      ...
                                                      decoration:
                                                        ...
                                                        hintText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          'waf2ejts' /* Confirma tu nueva contraseña */,
                                                        ),
                                                        hintStyle:
                                                            FlutterFlowTheme.of(
                                                                    context)
