                                                  ...
                                                  await launchUrl(Uri(
                                                      ...
                                                      query: {
                                                        'subject':
                                                            'Nueva postulacion',
                                                        'body':
                                                            '${_model.userNameTextFieldTextController.text}${_model.emailTextFieldTextController1.text}${_model.emailTextFieldTextController2.text}${_model.passwordTextFieldTextController.text}${_model.dropDownValue}${_model.uploadedFileUrl}${_model.emailTextFieldTextController3.text}',
                                                      }
                                                          .entries
                                                          .map((MapEntry<String,
                                                                      String>
